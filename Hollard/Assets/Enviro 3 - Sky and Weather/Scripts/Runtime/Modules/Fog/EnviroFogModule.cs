...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {  
            Shader.SetGlobalVector("_EnviroFogParameters", new Vector4(RayOriginTerm(Settings.fogDensity * 0.01f, Settings.fogHeightFalloff, Settings.fogHeight + Settings.globalFogHeight,cam), Settings.fogHeightFalloff, Settings.fogDensity * 0.01f, Settings.fogHeight + Settings.globalFogHeight));
            Shader.SetGlobalVector("_EnviroFogParameters2", new Vector4(RayOriginTerm(Settings.fogDensity2 * 0.01f, Settings.fogHeightFalloff2, Settings.fogHeight2 + Settings.globalFogHeight,cam), Settings.fogHeightFalloff2, Settings.fogDensity2 * 0.01f, Settings.fogHeight2 + Settings.globalFogHeight));
            ...
            Shader.SetGlobalVector("_WorldOffset",Settings.floatingPointOriginMod);
        } 
