    ...
    SubShader
    {
      	...
      	Pass
        {
            ...
            { 
                ...
                lowResDepth.x = Linear01Depth(LOAD_TEXTURE2D(_DownsampledDepth,i.uv00 * _DepthHandleScale.zw * _DepthHandleScale.xy).r, _ZBufferParams);
                lowResDepth.y = Linear01Depth(LOAD_TEXTURE2D(_DownsampledDepth,i.uv10 * _DepthHandleScale.zw * _DepthHandleScale.xy).r, _ZBufferParams);
                lowResDepth.z = Linear01Depth(LOAD_TEXTURE2D(_DownsampledDepth,i.uv01 * _DepthHandleScale.zw * _DepthHandleScale.xy).r, _ZBufferParams);
                lowResDepth.w = Linear01Depth(LOAD_TEXTURE2D(_DownsampledDepth,i.uv11 * _DepthHandleScale.zw * _DepthHandleScale.xy).r, _ZBufferParams); 
